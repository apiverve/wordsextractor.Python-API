...
class WordsextractorAPIClient:
    def __init__(self, api_key, secure=True):
        """
        Initialize the WordsextractorAPIClient with the API key and secure flag
        ...
        self.secure = secure
        self.base_url = 'https://api.apiverve.com/v1.0.9/wordsextractor'
        self.headers = {
